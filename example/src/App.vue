<template>
  <div id="app">
    ...
    <h1>vue-simple-alert examples</h1>
    <br />
    <h2>Alert examples</h2>
    <div id="examples">
      <div id="alert-example">
        <button @click="alertExample0" type="button">
          Normal Alert
        </button>
        <button
          @click="alertExample1"
      ...
      <div id="confirm-example">
        <button @click="confirmExample0" type="button">
          Normal Confirm
        </button>
        <button
      ...
      <div id="prompt-example">
        <button @click="promptExample0" type="button">
          Normal Prompt
        </button>
        <button
...
export default class App extends Vue {
  ...
  alertExample1() {
    this.$alert("This is simple and beautiful alert.");
  }
  alertExample2() {
    this.$alert("This is simple and beautiful alert with title.", "Example");
  }
  alertExample3() {
    this.$alert(
      "This is simple and beautiful alert with icon.",
      "Success",
      "success"
    );
  }
  ...
  confirmExample0() {
    confirm("This is normal confirm.");
  }
  confirmExample1() {
    this.$confirm("This is beautiful confirm.", "Confirm");
  }
  confirmExample2() {
    this.$confirm(
      "This is beautiful confirm with question icon.",
      "Question",
      "question"
    )
      .then(r => {
  ...
  confirmExample3() {
    this.$confirm(
      "This is beautiful confirm with error icon.",
      "Error",
      "error"
    )
      .then(r => {
  ...
  promptExample1() {
    this.$prompt("Input your name", "John Doe").then(r => {
